...
interface EmptyStateProps {
  icon: 'scan' | 'benchmark' | 'network' | 'memory' | 'receipt' | 'history' | 'settings'
  title: string
  description: string
  action?: ReactNode
}
...
const icons: Record<string, string> = {
  scan: 'M21 3H3v18h18V3zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z',
  benchmark: 'M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z',
  ...
  receipt: 'M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z',
...
export default function EmptyState({ icon, title, description, action }: EmptyStateProps) {
  return (
    <div className="empty-state" style={{ padding: 28 }}>
      <svg width="40" height="40" viewBox="0 0 24 24" fill="currentColor" style={{ opacity: 0.25, margin: '0 auto 12px' }}>
        <path d={icons[icon] || icons.scan} />
      </svg>
      <strong>{title}</strong>
      <p>{description}</p>
